  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path= "/synbio-orators"  element={<Orators />} />
        <Route path="/about-synbio" element={<AboutOralMed />} />
        <Route path="/synbio-event-schedule" element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/synbio-conference-tracks/"element={<RotatingLogos />} />
