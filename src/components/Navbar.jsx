...
const Navbar = () => {
  ...
  const nav_links = [
    { name: "Home", link: "/" },
    { name: "About", link: "/about-synbio" },
    { name: "Executive Panel", link: "/executive-panel-members/" },
    { name: "Tracks", link: "/synbio-conference-tracks/" },
    { name: "Orators", link: "/synbio-orators" },
    { name: "Schedule", link: "/synbio-event-schedule" },
  ...
  {nav_links.map((item, index) => {
    ...
    return (
      ...
      >
        ...
        <div className="lg:hidden z-300 ml-[190px]">
